...
export default function EditEntryPage() {
  ...
  // Move editor initialization before useEffect
  const editor = useEditor({
    ...
    content: editorContent, // Use editorContent instead of empty string
  ...
  // Modify useEffect to handle editor content properly
  useEffect(() => {
    const fetchEntry = async () => {
      try {
        ...
        // Only set editor content if editor exists
        if (editor) {
    ...
    fetchEntry(); // Remove the editor check here
  }, [editor, id]);
  ...
  // Update the page title to show it's an edit page
  return (
